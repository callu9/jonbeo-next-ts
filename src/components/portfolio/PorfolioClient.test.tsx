...
describe("PorfolioClient", () => {
  const stock = { code: "AAPL", name: "Apple", shares: 1, avgBuyPrice: 100, currentPrice: 120, profitLossMoney: 20, profitLossRate: 20 };

  it("renders server-provided summary in the initial server markup", () => {
    const markup = renderToStaticMarkup(<AccountSummaryClient accountSummary={{ cashBalance: 0, todayProfitMoney: 0, todayProfitRate: 0 }} />);
